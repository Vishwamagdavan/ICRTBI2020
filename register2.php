...
if (isset($_POST['submit'])) {
    ...
    header("Location: https://portal.stjosephstechnology.ac.in/sendPost.jsp?RUrl=https://portal.stjosephstechnology.ac.in/TechProcess?auth=fluffy%26amount=$extra_amount%26user=ICRTET%26custid=$name%26refno=$mtxnid%26returnURL=http://icrtbi2020.stjosephstechnology.ac.in/register2.php", TRUE, 307);
}
...
<body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="http://icrtbi2020.stjosephstechnology.ac.in/register2.php" style="color:white;">Try Again</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container" id="online-payment">
        <div class="row">
            <div class="col-md-2"></div>
            <div style="background-color: #e6e0e0" class="col-md-8">
                <br>
                <h4>Details</h4>
                <form id="form_38599" class="appnitro" enctype="multipart/form-data" method="post" action="register2.php">
                    <div class="form-row">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Register
                            ...
                            <li><button type="submit" id="saveForm" value="Make Payment" class="btn btn-primary">Online Payment Gateway (Credit Card / Debit Card)</button></li>
                            <li><button type="submit" id="saveForm" value="Make Payment" class="btn btn-primary" onclick="on()">NEFT / RTGS/ IMPS</button></li>
                        </ul>
                    </div>
                </form>
            </div>
    ...
    <div class="container" id="nift-payment">
        <div class="row">
            <div class="col-md-2">

            </div>
            <div class="col-md-8" style="background-color: #e6e0e0">
                <p style="color: red">Kindly transfer the above mentioned amount in the following account:<br>
                </p>
                <p>
                ...
                <h4>Details</h4>
                <form id="form_38599" class="appnitro" enctype="multipart/form-data" method="post" action="register2.php">
                    <label for="nift-payment-date">Date of Payment</label>
                    <input type="date" class="form-control" style="width: 200px" name="nift-payment-date">
                    <br>
                    <label for="nift-bank">Bank & Branch</label>
                    <input type="text" placeholder="INDIAN BANK,JEPPIAAR ENGINEERINGCOLLEGE SEMMENCHERR CHENNAI" name="nift-bank" class="form-control">
                    <br>
                    <label for="nift-ref">Ref.no</label>
                    <input type="text" placeholder="Ref. Number" class="form-control" name="nift-ref">
                    <br>
                    <label for="nift-amount">Amount Paid</label>
                    <input type="text" placeholder="RS.6000" class="form-control" name="nift-amount">
                    <br>
